    ...
    <div class="card">
      <div class="card-body">
       <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="card-title mb-0">LiveTV Settings</h4>
        @if($livetv->status == 1)
...
@csrf
  ...
  <div class="form-group">
      <label for="exampleTextarea1" class="mt-4">Embed Code For LiveTV</label>
      <textarea class="form-control" name="embed_code" id="exampleTextarea1">{{ $livetv->embed_code }}</textarea>
  </div>

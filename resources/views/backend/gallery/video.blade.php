	  ...
	  <div class="card-body">
	    ...
	    <div class="d-flex justify-content-between align-items-center mb-3">
	    	...
	    	<a href="{{ route('add.video') }}">
	    		<button type="button" class="btn btn-primary btn-fw float-right">Add Video</button>
	    	</a>
	    </div>
	    ...
	    <div class="table-responsive">
	      <table class="table table-bordered">
		    ...
		    <a href="{{ route('delete.video',$row->id) }}" onclick="return confirm('Are you sure you want to delete this video?')" class="btn btn-danger">Delete</a>

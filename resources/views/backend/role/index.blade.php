	...
	<div class="card">
	  <div class="card-body">
	    ...
	    <div class="d-flex justify-content-between align-items-center mb-3">
	    	<h4 class="card-title mb-0">Writer List</h4>
	    	<a href="{{ route('add.writer') }}">
	    		<button type="button" class="btn btn-primary btn-fw float-right">Add Writer</button>
	    	</a>
	    </div>
	    ...
	    <div class="table-responsive">
	      <table class="table table-bordered">
		    ...
		    <a href="{{ route('delete.writer',$row->id) }}" onclick="return confirm('Are you sure you want to delete this writer?')" class="btn btn-danger">Delete</a>

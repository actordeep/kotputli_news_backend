      ...
      <form class="forms-sample" method="POST" action="{{ route('update.ads', $ads->id) }}" enctype="multipart/form-data">
        ...
        <div class="row">
          <div class="form-group col-md-6">
            <label for="exampleInputName1">Ad Image Upload</label>
            <input type="file" name="ads" class="form-control-file" id="exampleFormControlFile1">
          </div>

          <div class="form-group col-md-6">
            <label for="exampleInputName1">Old Ad Image</label>
            <img src="{{ URL::to($ads->ads) }}" style="width:70px; height: 50px;" alt="Old Image">
            <input type="hidden" name="oldimage" value="{{ $ads->ads }}">
          </div>
        </div> <!-- End row -->

          <div class="form-group">
            <label for="exampleInputName1">Ad Type</label>

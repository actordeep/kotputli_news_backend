...
<!-- Search District Vertical First -->
<!--<ins class="adsbygoogle"-->
<!--     style="display:block"-->
<!--     data-ad-client="ca-pub-2972675998911168"-->
<!--     data-ad-slot="4263958654"-->
<!--     data-ad-format="auto"-->
...
@endphp
					...
					<!--google add second verticle start-->
<!--					<div class="row">-->
<!--						<div class="col-md-12 col-sm-12">-->
<!--							<div class="sidebar-add">-->
<!--					<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-2972675998911168"-->
<!--     crossorigin="anonymous"></script>-->
<!-- Search District Vertical Second -->
<!--<ins class="adsbygoogle"-->
<!--     style="display:block"-->
<!--     data-ad-client="ca-pub-2972675998911168"-->
<!--     data-ad-slot="4606739436"-->
<!--     data-ad-format="auto"-->
<!--     data-full-width-responsive="true"></ins>-->
<!--<script>-->
<!--     (adsbygoogle = window.adsbygoogle || []).push({});-->
...
<!--						</div>-->
<!--					</div>-->
					<!--google add second verticle end-->
			</div>			
		</div>
	</div>
</section>

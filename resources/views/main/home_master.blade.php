...
<head>
    ...
    <meta name="keyword"
        content="{{ isset($__env->getSections()['meta_keyword']) ? $__env->getSections()['meta_keyword'] : $seo->meta_keyword }}">
    ...
    <title>{{ isset($__env->getSections()['meta_title']) ? $__env->getSections()['meta_title'] : $seo->meta_title }}
    </title>
    <!-- Open Graph / Facebook -->
    <meta property="og:title" content="Kotputli News - Latest Updates from Kotputli, Jaipur, Rajasthan, India">
    <meta property="og:description"
        content="Get the latest news from Kotputli, Jaipur, Rajasthan, and India. Stay updated with local news, breaking news, and headlines. Read news in Hindi.">
...
<meta name="Expires" content="never" />
    ...
    <script type="text/javascript"
        src="https://platform-api.sharethis.com/js/sharethis.js#property=60993d2f30ef9700113f713e&product=inline-share-buttons"
        async="async"></script>
